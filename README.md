...
## Result:
Thus, the program for android application, Font Size and color was executed successfully using Android Studio.# Develop-an-application-that-uses-GUI-Components-with-Fonts-and-Colors
